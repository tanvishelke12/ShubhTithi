...
export const Sidebar = () => {
  return (
    ...
    <div className='sidebar-item'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fillRule="currentColor" className="bi bi-cart" viewBox="0 0 16 16">
    ...
    <div className='sidebar-item'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fillRule="currentColor" className="bi bi-list-task" viewBox="0 0 16 16">
